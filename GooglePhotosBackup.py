...
travel_album_id = dfAlbums[dfAlbums['title'] ==
                           'Snapchat']['id'].to_string(index=False).strip()
...
media_files = service.mediaItems().search(
    body={'albumId': travel_album_id}).execute()['mediaItems']

destination_folder = r'./photos_backup'
